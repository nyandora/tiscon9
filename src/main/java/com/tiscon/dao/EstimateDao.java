...
/**
 * 引越し見積もり機能においてDBとのやり取りを行うクラス。ああああ
 *
 * @author Oikawa Yumi
 */
@Component
public class EstimateDao {
    ...
    public int insertCustomer(Customer customer) {
        String sql = "INSERT INTO CUSTOMER(OLD_PREFECTURE_ID, NEW_PREFECTURE_ID, CUSTOMER_NAME, TEL, EMAIL, OLD_ADDRESS, NEW_ADDRESS, MOVE_MONTH)"
                + " VALUES(:oldPrefectureId, :newPrefectureId, :customerName, :tel, :email, :oldAddress, :newAddress, :moveMonth)";
